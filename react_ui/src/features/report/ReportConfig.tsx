    ...
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Laboratory</label>
                    <input
                        type="text"
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Drilling Company</label>
                    <input
                        type="text"
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Sample Type</label>
                    <input
                        type="text"
            ...
            <div className="space-y-2">
                ...
                <textarea
                    ...
                    className="w-full px-4 py-2 bg-surface-light border border-secondary-light rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-slate-50 placeholder:text-slate-500 h-32"
...
export const FiguresConfigForm: React.FC<FiguresConfigFormProps> = ({ config, onChange }) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
                <div className={`w-6 h-6 rounded border-2 flex items-center justify-center flex-shrink-0 transition-colors ${config.includeControlCharts ? 'bg-primary border-primary text-slate-50' : 'border-secondary-light'
                    }`}>
                    {config.includeControlCharts && <CheckSquare className="w-4 h-4" />}
                </div>
                <div>
                    <div className={`font-bold ${config.includeControlCharts ? 'text-primary' : 'text-slate-50'}`}>Control Charts</div>
                    <div className="text-sm text-slate-400">Standard performance plots</div>
                </div>
            </button>
            ...
            >
                <div className={`w-6 h-6 rounded border-2 flex items-center justify-center flex-shrink-0 transition-colors ${config.includeScatterPlots ? 'bg-primary border-primary text-slate-50' : 'border-secondary-light'
                    }`}>
                    {config.includeScatterPlots && <CheckSquare className="w-4 h-4" />}
                </div>
                <div>
                    <div className={`font-bold ${config.includeScatterPlots ? 'text-primary' : 'text-slate-50'}`}>Scatter Plots</div>
                    <div className="text-sm text-slate-400">Duplicate precision analysis</div>
                </div>
            </button>
            ...
            >
                <div className={`w-6 h-6 rounded border-2 flex items-center justify-center flex-shrink-0 transition-colors ${config.includeHistograms ? 'bg-primary border-primary text-slate-50' : 'border-secondary-light'
                    }`}>
                    {config.includeHistograms && <CheckSquare className="w-4 h-4" />}
                </div>
                <div>
                    <div className={`font-bold ${config.includeHistograms ? 'text-primary' : 'text-slate-50'}`}>Histograms</div>
                    <div className="text-sm text-slate-400">Distribution analysis</div>
                </div>
            </button>
            ...
            >
                <div className={`w-6 h-6 rounded border-2 flex items-center justify-center flex-shrink-0 transition-colors ${config.includeTables ? 'bg-primary border-primary text-slate-50' : 'border-secondary-light'
                    }`}>
                    {config.includeTables && <CheckSquare className="w-4 h-4" />}
                </div>
                <div>
                    <div className={`font-bold ${config.includeTables ? 'text-primary' : 'text-slate-50'}`}>Summary Tables</div>
                    <div className="text-sm text-slate-400">Statistical summaries</div>
                </div>
            </button>
        </div>
    );
